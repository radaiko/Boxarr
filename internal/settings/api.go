...
var writableKeys = map[string]bool{
	...
	KeyPlexMovieSection: true, KeyPlexTVSection: true, KeyPlexAnimeSection: true, KeySeerrAPIKeys: true,
	KeyAPIKey: true, KeyMovieLibraryRoot: true, KeyTVLibraryRoot: true, KeyAnimeLibraryRoot: true,
...
func (s *Store) EffectiveNonSecret() map[string]string {
	eff := map[string]string{
		...
		KeyAnimeLibraryRoot:     s.AnimeLibraryRoot(),
		KeyPlexAnimeSection:     s.PlexAnimeSection(),
