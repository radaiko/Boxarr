...
func TestManagerRunsTasks(t *testing.T) {
	...
	id := m.Enqueue("adopt", "The Matrix", func(context.Context, *Run) error { ran <- struct{}{}; return nil })
	if id != 1 {
...
func TestManagerRecordsErrors(t *testing.T) {
	m := New(context.Background())
	id := m.Enqueue("delete", "X", func(context.Context, *Run) error { return errors.New("boom") })
