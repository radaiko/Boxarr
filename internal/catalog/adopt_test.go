...
func TestResolveAdoptMovieAndSeries(t *testing.T) {
	...
	mt, ref, err := cat.ResolveAdopt(ctx, "The.Matrix.1999.1080p.BluRay.x264-GRP", "", 0)
	...
	if mt2, ref2, err2 := cat.ResolveAdopt(ctx, "The.Matrix.1999.2160p.WEB", "", 0); err2 != nil || mt2 != "movie" || ref2 != ref {
	...
	mt, ref, err = cat.ResolveAdopt(ctx, "Breaking.Bad.S01E01.1080p.WEB-DL", "", 0)
	...
	mt3, ref3, err3 := cat.ResolveAdopt(ctx, "Breaking.Bad.S01E01.2160p.WEB", "", 0)
